...
<title>update Payment details</title>
	<link rel="stylesheet" type="text/css" href="css/payUpdate.css">
...
%>
    ...
    <div class="container01">
        ...
        <form action="updatepayment" method="post">
            ...
            <!-- Add more input fields for other payment details if needed -->
            <button type="submit" class="btn btn-info btn-edit">Update Payment</button>
